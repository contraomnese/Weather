...
interface FavoritesDao {
    ...
    @Query(
        "INSERT INTO favorites (location_id, name, city, state, country, latitude, longitude, timezone_id) " +
                "SELECT network_id, name, city, state, country, latitude, longitude, timezone_id " +
