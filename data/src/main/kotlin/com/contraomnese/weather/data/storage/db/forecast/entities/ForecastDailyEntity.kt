...
@Entity(
    tableName = ForecastDailyEntity.TABLE_NAME,
    foreignKeys = [ForeignKey(
        entity = ForecastLocationEntity::class,
        parentColumns = [ForecastLocationEntity.ID],
        childColumns = [ForecastDailyEntity.FORECAST_LOCATION_ID],
        onDelete = ForeignKey.CASCADE
    )],
    indices = [Index(value = [ForecastDailyEntity.FORECAST_LOCATION_ID], name = "forecast_daily_forecast_location_id")]
)
