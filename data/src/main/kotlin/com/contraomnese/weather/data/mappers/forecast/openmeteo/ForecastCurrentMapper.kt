...
internal fun ForecastCurrentNetwork.toEntity(
    ...
    return ForecastTodayEntity(
        ...
        maxTempC = forecastDayEntities.first().maxTempC,
        maxTempF = celsiusToFahrenheit(forecastDayEntities.first().maxTempF),
        minTempC = forecastDayEntities.first().minTempC,
        minTempF = celsiusToFahrenheit(forecastDayEntities.first().minTempF),
        isDay = isDay,
