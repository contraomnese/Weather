...
@Entity(
    tableName = ForecastTodayEntity.TABLE_NAME,
    foreignKeys = [ForeignKey(
        entity = ForecastLocationEntity::class,
        parentColumns = [ForecastLocationEntity.ID],
        childColumns = [ForecastTodayEntity.FORECAST_LOCATION_ID],
        onDelete = ForeignKey.CASCADE,
    )],
    indices = [Index(value = [ForecastTodayEntity.FORECAST_LOCATION_ID], name = "forecast_today_forecast_location_id")]
)
data class ForecastTodayEntity(
    ...
    @ColumnInfo(name = AIR_QUALITY_CO) val airQualityCo: Double,
    @ColumnInfo(name = AIR_QUALITY_NO2) val airQualityNo2: Double,
    @ColumnInfo(name = AIR_QUALITY_O3) val airQualityO3: Double,
    ...
    companion object {
        const val TABLE_NAME = "forecast_today"
