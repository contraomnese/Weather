...
class OpenMeteoParser(
...
) : BaseNetworkParser<OpenMeteoErrorResponse>(OpenMeteoErrorResponse::class.java) {
    ...
    override fun provideApiCode(parsed: OpenMeteoErrorResponse?): Int? = null

    override fun provideMessage(parsed: OpenMeteoErrorResponse?): String? =
        parsed?.reason
}